 ...
 *
 * 2. Properties that cannot be relied on due to inconsistent browser support
 * (e.g., 'x' and 'y') are not added to the native event. Others that shouldn't
 * be arbitrarily customized (e.g., 'screenX') are automatically inferred from
 * associated values.
 *
 * 3. PointerEvent and TouchEvent fields are normalized (e.g., 'rotationAngle'
 * -> 'twist')
 */
