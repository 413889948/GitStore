 ...
 *
 * - The current event plugin system will traverse the list of injected
 * plugins,
 ...
 *   returned, but processed at a later time by the `EventPluginRegistry`
 * (hence the name deferred).
 *
 * In the process of returning their deferred-dispatched events, event plugins
 * themselves can dispatch events on-demand without returning them from
 * `extractEvents`. Plugins might want to do this, so that they can use event
 * dispatching as a tool that helps them decide which events should be
 * extracted
 * in the first place.
 *
 ...
 *   abstraction that allows event plugins to perform multiple "rounds" of
 * event
 *   extraction.
 *
