...
/**
 * Strip out complex data (instances, functions, and data nested >
 * LEVEL_THRESHOLD levels deep). The paths of the stripped out objects are
 * appended to the `cleaned` list. On the other side of the barrier, the
 * cleaned list is used to "re-hydrate" the cleaned representation into an
 * object with symbols as attributes, so that a sanitized object can be
